# PyQT5 이용해 UI 디자인 후 자동으로 .py 파일로 반환해 기능 구현을 위한 함수 연결
...
class Ui_MainWindow(object):
    ...
    def start_main(self):
        ...
        # ex) input_lineEdit에서 텍스트를 가져옵니다.
        ...
        # threading 모듈을 사용하여 GUI가 멈추지 않고 반응하도록 합니다. -> 프로그램 우측에 콘솔창을 출력해 진행경과를 보기 위한 기능
        import threading
...
if __name__ == "__main__":
    ...
    app.aboutToQuit.connect(restore_stdout)
