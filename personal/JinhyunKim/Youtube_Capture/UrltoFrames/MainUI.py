...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.url_lineEdit.setGeometry(QtCore.QRect(30, 150, 341, 31))
        font = QtGui.QFont()
        font.setPointSize(11)
        self.url_lineEdit.setFont(font)
        self.url_lineEdit.setClearButtonEnabled(False)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.url_lineEdit.setPlaceholderText(_translate("MainWindow", "유튜브 영상 URL을 입력하세요"))
    ...
    def start_main(self):
        ...
        import threading
        thread = threading.Thread(target=main_func, args=(url, dir, frame_interval))
        thread.start()
