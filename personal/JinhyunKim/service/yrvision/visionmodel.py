...
class YouRecoSIm(SimBck):
    ...
    def feature_extractor(self,image_dir, query_img): # Resnet-50으로부터 feature extraction/extra classification
    ...
    def retrieval_similar(self, image_dir, query_img):
        query_img_embedding, category = self.feature_extractor(image_dir, query_img)
        query_img_embedding = query_img_embedding.cpu()
